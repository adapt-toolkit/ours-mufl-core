...
[`CONTRIBUTING.md`](https://github.com/adapt-toolkit/ours-mufl-core/blob/main/CONTRIBUTING.md)
...
- **Bug reports and questions** — open an issue on the
  [ours-mufl-core repository](https://github.com/adapt-toolkit/ours-mufl-core).
...
If you are building on the core and encounter something that does not match the docs, open an
issue. Integration experience is the most useful signal at this stage.
