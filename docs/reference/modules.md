...
The core is eight MUFL libraries loaded by `config_load #"core"` from a consumer's
...
| [`a2a_control.mm`](https://github.com/adapt-toolkit/ours-mufl-core/blob/main/a2a_control.mm) | Control-plane transport: encrypted payload delivered to a contact over the `encrypted_channel`, validated on receipt. |
